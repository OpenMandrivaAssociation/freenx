...
/bin/touch %{buildroot}%{_localstatedir}/nxserver/nxhome/.ssh/{server.id_dsa.pub.key,client.id_dsa.key,authorized_keys2,known_hosts}
...
%if %with NomachineKey
        %{__cat} << EOF > %{_localstatedir}/nxserver/nxhome/.ssh/authorized_keys2
...
EOF
%else
        %{_bindir}/ssh-keygen -q -t dsa -N '' -f %{_localstatedir}/nxserver/nxhome/.ssh/local.id_dsa 2>&1 > /dev/null
        %{__mv} -f %{_localstatedir}/nxserver/nxhome/.ssh/local.id_dsa %{_localstatedir}/nxserver/nxhome/.ssh/client.id_dsa.key
        %{__mv} -f %{_localstatedir}/nxserver/nxhome/.ssh/local.id_dsa.pub %{_localstatedir}/nxserver/nxhome/.ssh/server.id_dsa.pub.key
        %{__cat} %{_localstatedir}/nxserver/nxhome/.ssh/server.id_dsa.pub.key >  %{_localstatedir}/nxserver/nxhome/.ssh/authorized_keys2
        
%endif
        /bin/echo -n "127.0.0.1 " > %{_localstatedir}/nxserver/nxhome/.ssh/known_hosts
        %{__cat} %{_sysconfdir}/ssh/ssh_host_rsa_key.pub >> %{_localstatedir}/nxserver/nxhome/.ssh/known_hosts
...
%attr(755,nx,root) %dir %{_localstatedir}/nxserver
%attr(755,nx,root) %dir %{_localstatedir}/nxserver/db
%attr(700,nx,root) %dir %{_localstatedir}/nxserver/db/closed
%attr(700,nx,root) %dir %{_localstatedir}/nxserver/db/failed
%attr(700,nx,root) %dir %{_localstatedir}/nxserver/db/running
%attr(755,nx,root) %dir %{_localstatedir}/nxserver/nxhome
%attr(700,nx,root) %dir %{_localstatedir}/nxserver/nxhome/.ssh
...
%attr(600,nx,root) %ghost %{_localstatedir}/nxserver/nxhome/.ssh/known_hosts
%attr(600,nx,root) %ghost %{_localstatedir}/nxserver/nxhome/.ssh/authorized_keys2
%attr(600,nx,root) %ghost %{_localstatedir}/nxserver/nxhome/.ssh/client.id_dsa.key
%attr(600,nx,root) %ghost %{_localstatedir}/nxserver/nxhome/.ssh/server.id_dsa.pub.key
